...
@section('title', 'Editar Plantilla de Correo Electrónico')

@section('content')
<h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Plantillas de Correo Electrónico /</span> Editar Plantilla
</h4>
    ...
    <div class="card-body">
        <form action="{{ route('admin.email-templates.update', $emailTemplate->id) }}" method="POST">
            ...
            @include('admin.email_templates._form', [
                ...
                'buttonText' => 'Actualizar Plantilla'
            ])
        </form>
    </div>
</div>
