...
@section('content')
<h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Administración / Pedidos /</span> Crear
</h4>

<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Formulario de Creación de Pedido</h5>
    </div>
    <div class="card-body">
        <form action="{{ Auth::user()->isStudent() ? route('student.orders.store') : route('admin.orders.store') }}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('course_type') is-invalid @enderror" id="course_type" name="course_type" value="{{ old('course_type') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('accommodation') is-invalid @enderror" id="accommodation" name="accommodation" value="{{ old('accommodation') }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('weeks') is-invalid @enderror" id="weeks" name="weeks" value="{{ old('weeks') }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3 form-check form-switch">
                    <input class="form-check-input @error('insurance') is-invalid @enderror" type="checkbox" id="insurance" name="insurance" value="1" {{ old('insurance') ? 'checked' : '' }}>
                    <label class="form-check-label" for="insurance">Seguro</label>
                    @error('insurance')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6 mb-3 form-check form-switch">
                    <input class="form-check-input @error('transport') is-invalid @enderror" type="checkbox" id="transport" name="transport" value="1" {{ old('transport') ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-6 mb-3 form-check form-switch">
                    <input class="form-check-input @error('parking_available') is-invalid @enderror" type="checkbox" id="parking_available" name="parking_available" value="1" {{ old('parking_available') ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3 form-check form-switch">
                    <input class="form-check-input @error('cancellation_policy') is-invalid @enderror" type="checkbox" id="cancellation_policy" name="cancellation_policy" value="1" {{ old('cancellation_policy') ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-6 mb-3 form-check form-switch">
                    <input class="form-check-input @error('university_certificate_ects') is-invalid @enderror" type="checkbox" id="university_certificate_ects" name="university_certificate_ects" value="1" {{ old('university_certificate_ects') ? 'checked' : '' }}>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('second_language') is-invalid @enderror" id="second_language" name="second_language" value="{{ old('second_language') }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('spanish_level') is-invalid @enderror" id="spanish_level" name="spanish_level" value="{{ old('spanish_level') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('study_center_name') is-invalid @enderror" id="study_center_name" name="study_center_name" value="{{ old('study_center_name') }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3 form-check form-switch">
                    <input class="form-check-input @error('smoking_preference') is-invalid @enderror" type="checkbox" id="smoking_preference" name="smoking_preference" value="1" {{ old('smoking_preference') ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3 form-check form-switch">
                    <input class="form-check-input @error('pets_preference') is-invalid @enderror" type="checkbox" id="pets_preference" name="pets_preference" value="1" {{ old('pets_preference') ? 'checked' : '' }}>
            ...
            {{-- Si es Admin/SuperAdmin, también pueden pre-establecer el estado al crear --}}
            @if(Auth::user()->isAdmin() || Auth::user()->isSuperAdmin())
            <div class="mb-3">
            ...
            <a href="{{ Auth::user()->isStudent() ? route('student.orders.index') : route('admin.orders.index') }}" class="btn btn-secondary">Cancelar</a>
        </form>
    </div>
</div>
@endsection