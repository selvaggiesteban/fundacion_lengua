...
return [
  ...
  "templateFree" => true,
  "templateDescription" => "Plantilla de Panel de Administración HTML de Bootstrap 5 + Laravel más potente y completa ¡construida para desarrolladores!",
  "templateKeyword" => "panel de control, panel de administración bootstrap 5, diseño bootstrap 5, bootstrap 5, plantilla de administración gratuita",
